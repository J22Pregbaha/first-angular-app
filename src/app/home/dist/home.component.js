...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.onSubmit = function (formValue) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1["default"].request(options).then(function (response) {
                                console.log(response.data);
                                _this.results = JSON.stringify(response.data);
                            })["catch"](function (err) {
                                console.error(err);
                            })];
                    case 1:
